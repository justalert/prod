...
class AuthController {
    ...
    // 4. Verificarea linkului (Actualizată pentru preluarea limbii din DB)
    public function verify() {
        ...
        try {
            ...
            // AM MODIFICAT AICI: Extragem și 'u.lang' din tabela users
            $stmt = $db->prepare("
            ...
            // AM MODIFICAT AICI: Setăm limba din sesiune conform preferinței din baza de date
